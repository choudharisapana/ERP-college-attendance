      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid md:grid-cols-4 gap-6">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 text-sm">
              Intelligent classroom and timetable management for higher
            ...
            <ul className="space-y-2 text-sm">
              <li>
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faChartLine}
                    className="mr-2 text-blue-400 group-hover:text-white transition-colors"
                  />
                  Dashboard
                </Link>
              </li>
              <li>
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faCalendarPlus}
                    className="mr-2 text-green-400 group-hover:text-white transition-colors"
                  />
                  Timetables
                </Link>
              </li>
              <li>
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faUsers}
                    className="mr-2 text-purple-400 group-hover:text-white transition-colors"
                  />
                  Faculty
                </Link>
              </li>
              <li>
                ...
                >
                  ...
                  <FontAwesomeIcon
                    ...
                    className="mr-2 text-orange-400 group-hover:text-white transition-colors"
                  />
                  Classrooms
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <Link
                to="/contact"
                className="flex items-center space-x-2 p-2 bg-blue-800/30 rounded-md hover:bg-blue-800/50 transition"
              >
              ...
              <div className="p-3 bg-gradient-to-r from-blue-800/40 to-purple-800/40 rounded-md border border-blue-500/30">
                <p className="text-xs text-gray-200">
                  ...
                  />
                  <strong>Pro Tip:</strong> Use our smart scheduling features to
                  optimize resources.
                </p>
              </div>
            </div>
        ...
        <div className="border-t border-blue-700 mt-6 pt-4 text-center text-xs">
          <p className="text-gray-300">
            © 2026{" "}
            <span className="text-white font-semibold">Smart Schedular</span>.
            All rights reserved.
          </p>
